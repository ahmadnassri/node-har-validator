...
describe('Request Only', function () {
  ...
  it('should fail on bad "url"', function (done) {
    validate.request(fixtures.request.invalid.url, function (err, valid) {
      valid.should.be.false
  ...
  it('should fail on bad "headers"', function (done) {
    validate.request(fixtures.request.invalid.headers, function (err, valid) {
      valid.should.be.false
  ...
  it('should fail on malformed "headers"', function (done) {
    validate.request(fixtures.request.invalid.malformed, function (err, valid) {
      valid.should.be.false
  ...
  it('should not fail with full example', function (done) {
    validate.request(fixtures.request.valid, function (err, valid) {
